...
<head>
    ...
    <title>Malik's Certificates</title>
    <link rel="icon" href="img/certificate.png">
        ...
        <div class="row mb-5">
          <div class="col-12 text-center" data-aos="fade">
              <div class="section_title text-center mb-65">
                  <span style="color: white;">Certificates</span>
                  <h3 style="color: #0c1028;">My Certificates</h3>
              </div>  
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-6 col-lg-6 mb-4">
            <div class="block__86547 d-block d-xl-flex align-items-stretch">
              <figure class="img" style="background-image: url('img/cer/2.png')">
              </figure>
              <div class="h-100">
          ...
          <div class="col-md-6 col-lg-6 mb-4">
            <div class="block__86547 d-block d-xl-flex align-items-stretch">
              <figure class="img" style="background-image: url('img/cer/33.png')">
              </figure>
              <div class="h-100">
          ...
          <div class="col-md-6 col-lg-6 mb-4">
            <div class="block__86547 d-block d-xl-flex align-items-stretch">
              <figure class="img" style="background-image: url('img/cer/4.png')">
              </figure>
              <div class="h-100">
          ...
          <div class="col-md-6 col-lg-6 mb-4">
            <div class="block__86547 d-block d-xl-flex align-items-stretch">
              <figure class="img" style="background-image: url('img/cer/55.png')">
              </figure>
              <div class="h-100">
          ...
          <div class="col-md-6 col-lg-6 mb-4">
            <div class="block__86547 d-block d-xl-flex align-items-stretch">
              <figure class="img" style="background-image: url('img/cer/8.png')">
              </figure>
              <div class="h-100">
